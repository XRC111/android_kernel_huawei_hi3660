...
{
	return hisi_tcpc_restart_timer(pd_port->tcpc_dev, timer_id);
}

static inline void pd_enable_timer(pd_port_t *pd_port, uint32_t timer_id)
{
	return hisi_tcpc_enable_timer(pd_port->tcpc_dev, timer_id);
}

static inline void pd_disable_timer(pd_port_t *pd_port, uint32_t timer_id)
{
	return hisi_tcpc_disable_timer(pd_port->tcpc_dev, timer_id);
}
