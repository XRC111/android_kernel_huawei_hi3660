...
bool hisi_pd_process_dpm_msg_vconn_swap(pd_port_t *pd_port, pd_event_t *pd_event);
...
#define PE_MAKE_STATE_TRANSIT_VIRT(state)	\
		hisi_hisi_pd_make_pe_state_transit_virt(\
			pd_port, pd_port->pe_state_curr, &state##_reactions)
/* PE_MAKE_STATE_TRANSIT_VIRT */

#define PE_MAKE_STATE_TRANSIT_FORCE(state, force)	\
		hisi_hisi_pd_make_pe_state_transit_force(\
...
bool hisi_hisi_pd_make_pe_state_transit_virt(pd_port_t *pd_port, uint8_t curr_state,
	const pe_state_reaction_t *state_reaction);
...
extern bool hisi_hisi_pd_process_event_snk(pd_port_t *pd_port, pd_event_t *evt);
extern bool hisi_hisi_pd_process_event_src(pd_port_t *pd_port, pd_event_t *evt);
extern bool hisi_hisi_pd_process_event_drs(pd_port_t *pd_port, pd_event_t *evt);
extern bool hisi_hisi_pd_process_event_prs(pd_port_t *pd_port, pd_event_t *evt);
extern bool hisi_hisi_pd_process_event_vdm(pd_port_t *pd_port, pd_event_t *evt);
extern bool hisi_hisi_pd_process_event_vcs(pd_port_t *pd_port, pd_event_t *evt);

#ifdef CONFIG_USB_PD_CUSTOM_DBGACC_SUPPORT
extern bool hisi_hisi_pd_process_event_dbg(pd_port_t *pd_port, pd_event_t *evt);
#endif	/* CONFIG_USB_PD_CUSTOM_DBGACC_SUPPORT */
